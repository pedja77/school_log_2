...
public class TeacherController {
	...
	public ResponseEntity<?> getAllTeachers(Principal p) {
...
//	@PostMapping()
//	@CrossOrigin(origins = "http://localhost:3000")
//	public ResponseEntity<?> createTeacher(@RequestBody TeacherDTO updatedTeacher, Principal p) {
//		String methodName = new Object() {
//		}.getClass().getEnclosingMethod().getName();
//		logger.info(String.format("[%s] Requested by %s", methodName, p.getName()));
//		
...
//	}
	...
	@CrossOrigin(origins = "http://localhost:3000")
	public ResponseEntity<?> getAllTeachersFiltered(@RequestParam String q, Principal p) {
		String methodName = new Object() {
		}.getClass().getEnclosingMethod().getName();
		logger.info(String.format("[%s] Requested by %s", methodName, p.getName()));
		
		return new ResponseEntity<>(teacherService.getAllTeachersFiltered(q), HttpStatus.OK);
	}
